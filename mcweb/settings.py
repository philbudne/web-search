...
env = environ.Env(      # @@CONFIGURATION@@ definitions (datatype, default value)
    ...
    ALL_CONTENT_CSV_EMAIL_MAX=(int, 200000),
    ALL_CONTENT_CSV_EMAIL_MIN=(int, 25000),
...
ALL_CONTENT_CSV_EMAIL_MAX = env('ALL_CONTENT_CSV_EMAIL_MAX')
ALL_CONTENT_CSV_EMAIL_MIN = env('ALL_CONTENT_CSV_EMAIL_MIN')
