...
CONSTANCE_REDIS_CHANNEL = "constance"

CONSTANCE_ADDITIONAL_FIELDS = {
    "long_text": ["django.forms.fields.CharField", {
...
CONSTANCE_CONFIG = {
    ...
    "LOG_RAW_QUERY_ENABLED": (False, "Log raw elasticsearch queries generated by mc-providers (DEV ONLY)"),
    "SYSTEM_ALERT": ("", "System alert message to show to users (set to empty string to disable)", "long_text"),
    "QUOTA_DEFAULT_MEDIA_CLOUD": (4000, "Default quota for Media Cloud API"),
}
