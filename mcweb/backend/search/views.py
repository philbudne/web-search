...
def error_response(msg: str, *, response_type: HttpResponse = HttpResponseBadRequest) -> HttpResponse:
...
def json_response(value: dict | str | None) -> HttpResponse:
    return json_response(value, default=str), content_type="application/json", status=200)
